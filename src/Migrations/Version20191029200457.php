 ...
 */
final class Version20191029200457 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE texts_delivery (id INT AUTO_INCREMENT NOT NULL, send_date DATETIME NOT NULL, type VARCHAR(15) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE email_subscription CHANGE periodicity periodicity VARCHAR(100) DEFAULT NULL, CHANGE format format LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', CHANGE source source LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE texts_delivery');
        $this->addSql('ALTER TABLE email_subscription CHANGE periodicity periodicity VARCHAR(100) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE format format LONGTEXT DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:array)\', CHANGE source source LONGTEXT DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:array)\'');
