 ...
 */
final class Version20190809204742 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE email_subscription (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, is_active TINYINT(1) NOT NULL, periodicity VARCHAR(100) DEFAULT NULL, days_ahead SMALLINT NOT NULL, UNIQUE INDEX UNIQ_F6D58280A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE email_subscription ADD CONSTRAINT FK_F6D58280A76ED395 FOREIGN KEY (user_id) REFERENCES fos_user_user (id)');
