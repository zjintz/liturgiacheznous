 ...
 */
final class Version20191013144055 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE email_subscription ADD format LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', ADD source LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', CHANGE periodicity periodicity VARCHAR(100) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE email_subscription DROP format, DROP source, CHANGE periodicity periodicity VARCHAR(100) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
