...
class IgrejaSantaInesFilterSantoralTest extends BaseFilterTest
{
    ...
    public function testFilter()
    {
        ...
        $liturgyText = $iFilter->filter($data, "2019-06-27");
        ...
        $this->assertEquals(new \DateTime("2019-06-27"), $liturgyText->getDate());
